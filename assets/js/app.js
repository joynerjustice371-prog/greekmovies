...
class GenresController {
  ...
  _applyFilter() {
    ...
    let filtered;
    try {
      filtered = this._active === 'all'
        ? this._all
        : this._all.filter(e => {
            const direct = (e.data?.genres || []);
      ...
      filtered = this._active === 'all'
        ? this._all.filter(e => e.data?.type !== 'movie')
        : this._all.filter(e => e.data?.type !== 'movie' && classifyEntry(e).includes(this._active));
    }
